                ...
                <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-12 items-center">
                    ...
                    <div className="w-full lg:w-1/2">
                        <div className="max-w-3xl mx-auto text-center mb-8">
                            <h2 className="text-3xl sm:text-4xl font-bold text-green-900 mb-2">Neem contact op</h2>
                        ...
                        >
                            ...
                            {/* Statusbericht */}
                            {successMessage && (
                                <p className={`text-center font-medium ${successMessage.includes('✅') ? 'text-green-700' : 'text-red-600'}`}>
                                    {successMessage}
                                </p>
                            )}
                        </form>
